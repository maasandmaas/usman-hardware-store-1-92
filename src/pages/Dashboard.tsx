    ...
    <div className="flex-1 p-6 space-y-6 bg-background min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="border-l-4 border-l-blue-700 hover:shadow-lg transition-all duration-300">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-foreground">Rs. {dashboardStats.totalSales.toLocaleString()}</div>
        ...
        <Card className="border-l-4 border-l-indigo-700 hover:shadow-lg transition-all duration-300">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-foreground">Rs. {dashboardStats.cashSales.toLocaleString()}</div>
        ...
        <Card className="border-l-4 border-l-purple-700 hover:shadow-lg transition-all duration-300">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-foreground">Rs. {dashboardStats.creditSales.toLocaleString()}</div>
            <div className="text-xs text-muted-foreground mt-1">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <Card className="hover:shadow-lg transition-shadow duration-300">
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">Cash vs Credit sales comparison for the week</p>
          </CardHeader>
          <CardContent>
        ...
        <Card className="hover:shadow-lg transition-shadow duration-300">
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">Distribution of sales across furniture hardware categories</p>
          </CardHeader>
          <CardContent>
            <ChartContainer config={chartConfig} className="h-[300px] w-full">
              <ResponsiveContainer width="100%" height="100%">
      ...
      <Card className="hover:shadow-lg transition-shadow duration-300">
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">Sales performance over the last 6 months</p>
        </CardHeader>
        <CardContent>
          ...
          <CardContent>
            <div className="space-y-4">
              {lowStockItems.map((item) => (
                <div key={item.id} className="flex items-center justify-between p-4 bg-red-50 dark:bg-red-950 rounded-lg border border-red-200 dark:border-red-800 hover:bg-red-100 dark:hover:bg-red-900 transition-colors">
                  <div className="flex-1">
                    <p className="font-medium text-foreground">{item.name}</p>
                    <p className="text-sm text-red-700 dark:text-red-400">Current: {item.current} | Min: {item.minimum}</p>
                  </div>
                  <Button
                    size="sm"
